...
def _get_funcs():
    from app.routers.credentials import _mask_config, _field_is_secret
    return _mask_config, _field_is_secret


class TestFieldIsSecret:
    def test_secret_fields_detected(self):
        _, _field_is_secret = _get_funcs()
