    ...
    <div className="p-6 space-y-5">
      ...
      <div className="flex items-start justify-between gap-4">
        <div>
          ...
          <p className="text-sm text-gray-500 mt-0.5">Track system activity, alerts, infrastructure events, and audit records across your fleet.</p>
        </div>
      ...
      <div className="flex gap-1 border-b border-gray-200">
        {(["all","alerts","audit"] as const).map(t => (
          <button key={t} onClick={() => { setTab(t); setPage(1); }}
            ...
            {t === "all" ? "All Events" : t === "alerts" ? "Alerts" : "Audit Trail"}
          </button>
        ))}
      </div>
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="col-span-2 bg-white rounded-2xl border border-gray-200 shadow-sm p-5">
          <div className="flex items-center justify-between mb-4">
            <h2 className="text-sm font-semibold text-gray-800">Event volume</h2>
      ...
      <div className="flex gap-4">
        <div className="flex-1 min-w-0 bg-white rounded-2xl border border-gray-200 shadow-sm overflow-hidden">
          ...
          <div className="px-5 py-4 border-b border-gray-100 flex items-center justify-between gap-3 flex-wrap">
            <h2 className="text-sm font-semibold text-gray-800 shrink-0">Recent event logs</h2>
