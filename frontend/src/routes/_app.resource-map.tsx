...
interface RmNodeData extends Record<string, unknown> {
  label: string;
  name: string;
  meta?: string;
  details?: string;
...
interface RmApiEdge { from: string; to: string; label?: string }
interface RmApiData {
...
function layoutNodes(apiNodes: RmApiNode[], rootId: string): Map<string, { x: number; y: number }> {
...
function apiToFlow(rmData: RmApiData): { nodes: Node[]; edges: Edge[] } {
